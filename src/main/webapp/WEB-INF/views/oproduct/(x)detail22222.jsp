...
<body>
				...
				<div class="content_area">
					...
					<div class="content_top">
						...
						<div class="ct_right_area">
							...
							<div class="line"></div>
							<div class="year">
								<span> 등록일 </span> <span>|</span> <span> <fmt:formatDate
										value="${dto.regDate}" pattern="yyyy-MM-dd" />
								</span> <span>
									&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;재고 </span> <span>|</span>
								<span> <fmt:formatNumber value="${dto.productStock}"
										pattern="#,### 개" />
								</span>
							</div>
							<div class="line"></div>
							<div class="price">
								...
								<div class="discount_price">
									판매가 : <span class="discount_price_number"><fmt:formatNumber
											value="${dto.productPrice - (dto.productPrice)*(dto.productDC*0.01)}"
											pattern="#,### 원" /></span> [
									<fmt:formatNumber value="${dto.productDC}" pattern="###" />
									%
									<fmt:formatNumber
										value="${dto.productPrice*(dto.productDC*0.01)}"
										pattern="#,### 원" />
									할인]
								</div>
								<div>
							...
							<div class="button">
								<div class="button_quantity">
									주문수량 <input type="text" value="1" id="count_check"> <span>
										<button id="plus_btn">+</button>
										<button id="minus_btn">-</button>
									</span>
								</div>
								<div id="button_set">
									<button type="button" class="btn_cart" data-id="${member.id}"
										data-proNum="${dto.productNum}">장바구니 담기</button>
					...
					<div class="col-lg-12">
						<div class="product__details__tab">
							...
							<div class="tab-content">
								<div class="tab-pane active content_middle" id="tabs-1"
									role="tabpanel">
									<div class="product__details__tab__desc product_intro">
										<h6>제품 상세</h6>
										<div style="white-space: pre;">
											<c:out value="${dto.productDetail}" />
										</div>
									</div>
								</div>
	...
	<!-- Modal  -->
	<ul class="nav">
		<li><a data-toggle="modal" href="#loginModal">Review 작성</a>
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							...
							<form action="../oproductReview/add" method="POST"
								enctype="multipart/form-data">
								<div hidden="${result.replyNum}" id="replyNum"></div>
								<input type="hidden" name="num" value="${dto.productNum}"
									id="num"> 글쓴이 <input type="text" name="writer"
									value="${member.id}" readonly="readonly"> 리뷰내용
	...
	<form action="../pay/payFormDetail" method="post" id="pay_frm">
		<input type="hidden" name="productNum" id="pay_pNum"
			value="${dto.productNum}"> <input type="hidden"
			name="productAmount" id="pay_pAmount"> <input type="hidden"
			name="id" value="${member.id}" id="loginCheck">
	</form>
